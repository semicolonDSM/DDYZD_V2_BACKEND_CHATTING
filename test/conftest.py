...
def db_setting(flask_app):
    with flask_app.app_context():
        ...
        db.session.add(User(name='최민준', gcn='1119', image_path='profile5'))
        ...
        db.session.add(Room(id=3, user_id=4, club_id=1, status='S'))
        db.session.add(Room(id=4, user_id=5, club_id=1, status='R'))
